    ...
    public class CodeWriter
    {
        ...
        public void AddClrType(Type type)
        {
            var scriptType = type switch
            {
                ...
                {
                    var scriptType = ParseClrType(typeof(IEnumerable<>).MakeGenericType(type.GetElementType()));
        ...
        private ScriptType ParseClrType(Type clrType)
        {
            ...
            if (clrType.IsGenericType)
            {
                ...
                else
                {
                    ...
                    return ParseClrType(definition);
                }
